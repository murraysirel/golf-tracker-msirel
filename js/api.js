...
export async function loadGroupData(groupCode) {
  ...
  try {
    ...
    // Guard: if Supabase has no record of this group at all (0 players, 0 rounds,
    // empty settings) it's a legacy/ghost code generated by ensureGroupCode() that
    // was never registered in the groups table. Don't wipe existing Gist data.
    const s0 = settings || {};
